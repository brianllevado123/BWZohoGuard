...
foreach ($files as $file) {
    ...
    match (true) {
        ...
        str_contains($file, determineSeparator('src/BWZohoGuardServiceProvider.php')) => rename($file, determineSeparator('./src/'.$className.'ServiceProvider.php')),
        ...
        str_contains($file, determineSeparator('config/bitwarden.php')) => rename($file, determineSeparator('./config/'.$packageSlugWithoutPrefix.'.php')),
